...
public class IOQ {
    ...
    static boolean inputBoolean(String prompt){
        ...
        try{result = Boolean.valueOf(input(prompt).trim()).booleanValue();}
    ...
    static String input(String prompt){
        ...
        try{inputLine = (new java.io.BufferedReader(new java.io.InputStreamReader(System.in))).readLine();}
        catch (Exception e){String err = e.toString();System.out.println(err);inputLine = "";}
        return inputLine;
    }
}// end of class
